...
Java_com_east_ffmpeg83_DVideoView_nativeDecodeVideo(JNIEnv *env, jobject instance,
...
Java_com_east_ffmpeg83_DVideoView_nativeDecodeAudio(JNIEnv *env, jobject instance,
                                                       jstring videoPath_) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_MainActivity_operateDir(JNIEnv *env, jobject instance,
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_NativeMedia_printAudioInfo(JNIEnv *env, jclass j_cls,
                                                     jstring absolutePath_) {
    const char *absolutePath = env->GetStringUTFChars(absolutePath_, 0);
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_NativeMedia_extractAudio(JNIEnv *env, jclass type, jstring filePath_) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_MainActivity_extractVideo(JNIEnv *env, jobject obj, jstring url_) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_media_DarrenPlayer_nPrepare(JNIEnv *env, jobject instance, jstring url_) {
    const char *url = env->GetStringUTFChars(url_, 0);
    if (fFmpeg == NULL) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_media_DarrenPlayer_nPrepareAsync(JNIEnv *env, jobject instance, jstring url_) {
    const char *url = env->GetStringUTFChars(url_, 0);
    if (fFmpeg == NULL) {
        if (jni_player_call == NULL) {
            jni_player_call = new JNIPlayerCall(javaVM, env, instance);
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_media_DarrenPlayer_nStart(JNIEnv *env, jobject instance) {
    if (fFmpeg) {
        fFmpeg->start();
    }
}
...
Java_com_east_ffmpeg83_MainActivity_opslESPlay(JNIEnv *env, jobject instance,
                                                  jstring url_) {
    const char *url = env->GetStringUTFChars(url_, 0);
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_media_DarrenPlayer_nPause(JNIEnv *env, jobject instance) {
    if (fFmpeg != NULL) {
        fFmpeg->onPause();
    }
}
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_media_DarrenPlayer_nResume(JNIEnv *env, jobject instance) {
    if (fFmpeg != NULL) {
        fFmpeg->onResume();
    }
}
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_media_DarrenPlayer_nStop(JNIEnv *env, jobject instance) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_east_ffmpeg83_media_DarrenPlayer_nSeekTo(JNIEnv *env, jobject instance, jint seconds) {
    // TODO
    if (fFmpeg != NULL) {
        fFmpeg->seek(seconds);
    }
