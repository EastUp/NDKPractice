...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_input.setText("/storage/emulated/0/test.mp4");
        et_output.setText("/storage/emulated/0/out.mp4");
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    int ret = FFmpegNativeBridge.runCommand(new String[]{"ffmpeg",
                            ...
                            "-b:v", "450k",
                            "-b:a", "96k",
                            et_output.getText().toString()}, new FFmpegNativeBridge.CompressCallback() {
                        @Override
                        public void onCompress(int current, int total) {
                            Log.e("SSTAG", "压缩进度："+current+"/"+total);
                        }
                    });
