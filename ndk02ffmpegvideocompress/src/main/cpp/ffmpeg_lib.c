...
Java_com_east_ndk02ffmpegvideocompress_FFmpegNativeBridge_innerRunCommand(JNIEnv *env, jclass type,
...
Java_com_east_ndk02ffmpegvideocompress_FFmpegNativeBridge_setDebug(JNIEnv *env, jclass type, jboolean debug) {
