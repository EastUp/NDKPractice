...
Java_com_east_ndk02ffmpegvideocompress_VideoCompress_compressVideo(JNIEnv *env, jobject instance,
...
Java_com_east_ndk02ffmpegvideocompress_MainActivity_stringFromJNI( JNIEnv* env,
                                                  jobject thiz )
{
    char str[25];
    sprintf(str, "%d", avutil_version());
