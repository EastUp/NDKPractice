...
#define FFMPEG_CONFIGURATION "--target-os=android --disable-static --enable-shared --enable-protocols --enable-cross-compile --enable-optimizations --disable-debug --enable-small --disable-doc --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-symver --disable-network --disable-x86asm --disable-asm --enable-pthreads --enable-mediacodec --enable-jni --enable-zlib --enable-pic --enable-avresample --enable-decoder=h264 --enable-decoder=mpeg4 --enable-decoder=mjpeg --enable-decoder=png --enable-decoder=vorbis --enable-decoder=opus --enable-decoder=flac --logfile=android-build/log/config_x86_64.log --prefix=android-build --libdir=android-build/libs/x86_64 --incdir=android-build/includes/x86_64 --pkgconfigdir=android-build/pkgconfig/x86_64 --cross-prefix='D:/AndroidSdk/ndk/21.2.6472646/toolchains/llvm/prebuilt/windows-x86_64/bin/x86_64-linux-android-' --arch=x86_64 --sysroot='D:/AndroidSdk/ndk/21.2.6472646/toolchains/llvm/prebuilt/windows-x86_64/sysroot' --cc='D:/AndroidSdk/ndk/21.2.6472646/toolchains/llvm/prebuilt/windows-x86_64/bin/x86_64-linux-android29-clang' --cxx='D:/AndroidSdk/ndk/21.2.6472646/toolchains/llvm/prebuilt/windows-x86_64/bin/x86_64-linux-android29-clang++' --ld='D:/AndroidSdk/ndk/21.2.6472646/toolchains/llvm/prebuilt/windows-x86_64/bin/x86_64-linux-android29-clang' --cpu=x86-64 --extra-cflags='-D__ANDROID_API__=29 -Os -fPIC -DANDROID -march=x86-64 -mtune=intel -msse4.2 -mpopcnt -m64' --extra-ldflags='-lc -lm -ldl -llog '"
