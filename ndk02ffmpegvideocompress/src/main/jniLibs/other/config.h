...
#define FFMPEG_CONFIGURATION "--prefix=android/armv7-a --target-os=android --arch=arm --cpu=armv7-a --enable-asm --enable-neon --enable-cross-compile --enable-shared --disable-static --disable-doc --disable-ffplay --disable-ffprobe --disable-symver --disable-ffmpeg --sysroot=/Volumes/MacDataStore/AndroidSdk/ndk/21.2.6472646/toolchains/llvm/prebuilt/darwin-x86_64/sysroot --cross-prefix=/Volumes/MacDataStore/AndroidSdk/ndk/21.2.6472646/toolchains/llvm/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --cross-prefix-clang=/Volumes/MacDataStore/AndroidSdk/ndk/21.2.6472646/toolchains/llvm/prebuilt/darwin-x86_64/bin/armv7a-linux-androideabi21- --extra-cflags=-fPIC"
