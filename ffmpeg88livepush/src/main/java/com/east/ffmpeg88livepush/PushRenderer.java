...
public class PushRenderer implements GLSurfaceView.Renderer {
    ...
    private int mFragmentRender = -1;

    public PushRenderer(Context context, int textureId) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        if (mFragmentRender == -1) {
            mFragmentRender = R.raw.fragment_shader;
        }
        String fragmentSource = Utils.getGLResource(mContext, mFragmentRender);
    ...
    public void setFragmentRender(int fragmentRender) {
        this.mFragmentRender = fragmentRender;
    }
}
